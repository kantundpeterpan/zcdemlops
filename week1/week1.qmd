---
title: "MLOPs: Week 1 - Introduction"
author: Heiner Atze
# execute:
#   cache: true
format:
...
## Operate
MLOps = set of best practices to ensures smooth operations of a deployed ML model
...
Ref. [Machine Learning operations maturity model](https://learn.microsoft.com/en-us/azure/architecture/ai-ml/guide/mlops-maturity-model)
...
- experiment tracking
- reproducibility
- DS still separated from Engineers
...
see [notebook](https://nbviewer.org/github/kantundpeterpan/zcdemlops/blob/main/week1/train_model/duration_prediction_yellow.ipynb)